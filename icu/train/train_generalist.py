...
class ICUGeneralistModule(pl.LightningModule):
    ...
    def on_fit_start(self):
        """
        CRITICAL FIX: DDP-Safe Normalizer Calibration.
    ...
    def _run_generative_sampling(self, batch: Dict[str, torch.Tensor]):
        ...
        self.log("val/generative_mse", mse, on_epoch=True, sync_dist=True)
        self.log("val/generative_mae", mae, on_epoch=True, sync_dist=True)
...
def main(cfg: DictConfig):
    ...
    # 2. DataModule
    datamodule = ICUGeneralistDataModule(cfg)
